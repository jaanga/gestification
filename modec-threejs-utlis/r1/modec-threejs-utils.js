...
// axis
		...
		mesh.castShadow = true;
		mesh.receiveShadow = true;
		mesh.doIt = function() { headsUp.innerHTML = 'Reset canera'; resetCamera( camX, camY, camZ ); };
		collidableMeshList.push( mesh );
		scene.add( mesh );
